export const Bio = {
  ...
  description:
    "I am a motivated and versatile Frontend Developer with 3+ years of experience, always eager to take on new challenges. With a passion for learning and strong skills in React.js, Next.js, Redux, and Tailwind CSS, I am dedicated to delivering high-quality results. With a positive attitude and a growth mindset, I strive to make meaningful contributions, adapt quickly to new technologies, and consistently achieve impactful outcomes.",
  github: "https://github.com/dineshnetha18",
  resume:
    "https://drive.google.com/file/d/1E7PZRJmrenGhJ4mx5EdC3pohkPr1eM0Y/view?usp=sharing",
  linkedin: "https://www.linkedin.com/in/dinesh-kumar-gaddam-79130633b",
...
export const experiences = [
  {
    ...
    doc: "https://www.linkedin.com/in/dinesh-kumar-gaddam-79130633b"
  },
  {
    id: 1,
    ...
    desc: "Worked on HRMS and E-Education platforms, building responsive interfaces using React.js, Redux, and Tailwind CSS. Collaborated with backend teams to design RESTful APIs, resolved performance bottlenecks, and improved UI responsiveness. Implemented reusable components, optimized rendering with React.memo/useCallback, and provided 24/7 production support while following Agile methodologies.",
    skills: [
      "React.js",
      "Redux",
      "Tailwind CSS",
...
export const TimeLineData = [
  { year: 2014, text: "Completed Secondary School (SSC)" },
  { year: 2016, text: "Completed Intermediate in Science" },
  { year: 2020, text: "Graduated with a B.Tech degree from TKR College of Engineering and Technology" },
  { year: 2022, text: "Started career as Frontend Developer at Aarmec Technologies" },
  { year: 2023, text: "Contributed to E-Education and HRMS Portal projects" },
  { year: 2024, text: "Joined InnovateFirst Solutions LLP as Frontend Developer" },
  { year: 2025, text: "Working on Forex Brokerage Trading Platform with React, Next.js, GraphQL and WebSockets" },
];
